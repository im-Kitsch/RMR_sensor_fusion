...
#define num_64b 5	//Number of 64 Bit - variables in protocol (for example: long*, uint64_t*, int64_t*, ...) | Default: 0
...
/*	--- Protocol Parameter --- */
#define Cnum_8b 1	//Number of 8 Bit - variables in protocol (for example: char, uint8_t, int8_t, ...) | Default: 1
#define Cnum_16b 5	//Number of 16 Bit - variables in protocol (for example: uint16_t, int16_t, ...) | Default: 0
