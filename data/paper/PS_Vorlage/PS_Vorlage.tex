...
Der Anwender greift in diesem \emph{union} über den \emph{struct} \emph{protocol_u} auf die einzelnen Datenfelder zu und kann das nächste zu sendende Paket somit manipulieren. 
Die Protokollfunktionen greifen über das Bytearray \emph{bytestream} auf die PDU zu, interpretieren die Sensordaten also als Bytefolge. 
in Beispiel für eine solche Protokollfunktion 
