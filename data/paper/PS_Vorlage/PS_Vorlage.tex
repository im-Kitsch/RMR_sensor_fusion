...
\begin{document}
\newcommand{\euertitel}{Entwicklung eines Protokolls zur Eingliederung einer Hardwarekomponente in ein Hexacopter-System}   % Titel hier eintragen!
...
\bibitem{TUT_HLP}
\emph{Tutorial: Flashing and programming of the Asctec Firefly's HLP using Windows 10}, 2018, (URL: \url{https://github.com/im-Kitsch/RMR_sensor_fusion/blob/master/data/tutorials/Tutorial_HLP_Flashing.pdf}, Zugriff: 03.07.18).
